    ...
    navbarPage("Next Word Prediction",
               ...
               tabPanel("Home",
                        fluidPage( 
                            ...
                            fluidRow(column(1, ""), 
                                     column(11, h1("Word Predictor", style="color: black"))),
                            fluidRow(column(1, ""), 
                                     column(11, textInput("text", 
                                                          label = p("Type the text here", 
                                                                    style="color: black;"),
                                                          value = ""))),
                            ...
                            fluidRow(column(1, ""), 
                                     column(3, 
                                            h3(textOutput("value"), 
                                               style="background-color:#A2F1FC; padding: 20px 20px 20px 20px;color: #666;font-weight: 500; border: solid 2px;")) , 
                                     column(8, "")))),
